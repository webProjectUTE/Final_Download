  ...
  <div class="modalbtn">
    ...
    <div class="row">
        ...
        <ul class="col-3 sidebar-menu box">
            ...
            <li><a href="http://nhatsang-survey.ap-southeast-1.elasticbeanstalk.com/" class="sidebar-item">
            ...
            <li><a href="http://nhatsang-cart.ap-southeast-1.elasticbeanstalk.com/" class="sidebar-item">
                <i class="fab fa-java sidebar-icon text-white"></i>
                <span class="sidebar-text text-white">Cart</span>
            </a></li> 
            <li><a href="http://nhatsang-email.ap-southeast-1.elasticbeanstalk.com/" class="sidebar-item">
                <i class="fab fa-java sidebar-icon text-white"></i>
                <span class="sidebar-text text-white">Email</span>
            </a></li>
            <li><a href="http://nhatsang-useradmin.ap-southeast-1.elasticbeanstalk.com/" class="sidebar-item">
                <i class="fab fa-java sidebar-icon text-white"></i>
